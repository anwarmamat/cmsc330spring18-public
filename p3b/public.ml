...
let test_stmt_basic ctxt = 
  let env = [("a", Bool_Val true); ("b", Int_Val 7)] in assert_stmt_success env env "int main(){}";
...
let test_define_1 = create_system_test [] [("a", Int_Val 0)] "public_inputs/define1.c"
let test_define_2 = create_system_test [] [("a", Bool_Val false)] "public_inputs/define2.c"

(* Simple assign int/bool/exp*)
let test_assign_1 = create_system_test [] [("a", Int_Val 100)] "public_inputs/assign1.c"
let test_assign_2 = create_system_test [] [("a", Bool_Val true)] "public_inputs/assign2.c"
let test_assign_exp = create_system_test [] [("a", Int_Val 0)] "public_inputs/assign-exp.c"
    ~output:"0\n"

(* equal & not equal & less *)
let test_notequal = create_system_test [] [("a", Int_Val 100)] "public_inputs/notequal.c"
    ~output:"100\n"
let test_equal = create_system_test [] [("a", Int_Val 200)] "public_inputs/equal.c" 
    ~output:"200\n"
let test_less = create_system_test [] [("a", Int_Val 200)] "public_inputs/less.c"
    ~output:"200\n"

(* Some expressions *)
let test_exp_1 = create_system_test [] [("a", Int_Val 322)] "public_inputs/exp1.c" 
    ~output:"322\n"
let test_exp_2 = create_system_test [] [("a", Int_Val 8002)] "public_inputs/exp2.c" 
    ~output:"8002\n"
let test_exp_3 = create_system_test [] [("a", Int_Val (-1))] "public_inputs/exp3.c" 
    ~output:"-1\n"

(* If/ Else/ While *)
let test_ifelse = create_system_test [] [("a", Int_Val 200)] "public_inputs/ifelse.c"
let test_if_else_while = create_system_test [] [("b", Int_Val 0);("a", Int_Val 200)] "public_inputs/if-else-while.c"
let test_while = create_system_test [] [("a", Int_Val 10); ("b", Int_Val 11)] "public_inputs/while.c" 
    ~output:"1\n3\n5\n7\n9\n"
let test_nested_ifelse = create_system_test [] [("a", Int_Val 400)] "public_inputs/nested-ifelse.c"
let test_nested_while = create_system_test [] [("sum", Int_Val 405);("j", Int_Val 10); ("i", Int_Val 10)] "public_inputs/nested-while.c"
...
let test_test_1 = create_system_test [] [("a", Int_Val 10);("sum", Int_Val 45); ("b", Int_Val 10)] "public_inputs/test1.c"
    ~output:"1\n10\n1\n3\n10\n3\n6\n10\n6\n10\n10\n10\n15\n10\n15\n21\n10\n21\n28\n10\n28\n36\n10\n36\n45\n20\n45\n"
let test_test_2 = create_system_test [] [("a", Int_Val 10);("c", Int_Val 0); ("b", Int_Val 20)] "public_inputs/test2.c"
    ~output:"10\n"
  let test_test_3 = create_system_test [] [("a", Int_Val 10);("c", Int_Val 64); ("b", Int_Val 2)] "public_inputs/test3.c"
      ~output:"64\nfalse\n"
